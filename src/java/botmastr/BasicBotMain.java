...
import botmastr.unit.CombatManager;
...
public final class BasicBotMain extends DefaultBWListener {
    ...
    @Override
    public void onStart() {
        this.mirror.getGame().enableFlag(1);
        BWTA.readMap();
        BWTA.analyze();
        ...
        NavigationManager.getInstance().init(this.mirror);
        CombatManager.getInstance().init(this.mirror);
        this.buildOrder1();
        this.trainSome();
   }
...
//        TrainingManager.getInstance().addQueueItem(new TrainingQueueItem(EPriority.LOW, UnitType.Protoss_Zealot));
        TrainingManager.getInstance().addQueueItem(new TrainingQueueItem(EPriority.LOW, UnitType.Protoss_Dragoon));
        TrainingManager.getInstance().addQueueItem(new TrainingQueueItem(EPriority.LOW, UnitType.Protoss_Dragoon));
        TrainingManager.getInstance().addQueueItem(new TrainingQueueItem(EPriority.LOW, UnitType.Protoss_Dragoon));
        TrainingManager.getInstance().addQueueItem(new TrainingQueueItem(EPriority.LOW, UnitType.Protoss_Dragoon));
        TrainingManager.getInstance().addQueueItem(new TrainingQueueItem(EPriority.LOW, UnitType.Protoss_Dragoon));
...
//        BuildingManager.getInstance().addQueueItem(new BuildingQueueItem(EPriority.HIGH, UnitType.Terran_Barracks));
        BuildingManager.getInstance().addQueueItem(new BuildingQueueItem(EPriority.MEDIUM, UnitType.Protoss_Gateway));
        BuildingManager.getInstance().addQueueItem(new BuildingQueueItem(EPriority.MEDIUM, UnitType.Protoss_Gateway));
        BuildingManager.getInstance().addQueueItem(new BuildingQueueItem(EPriority.MEDIUM, UnitType.Protoss_Cybernetics_Core));
...
//        BuildingManager.getInstance().addQueueItem(new BuildingQueueItem(EPriority.LOW, UnitType.Protoss_Pylon));
    ...
    public void onFrame() {
        ...
        try {
            ...
            NavigationManager.getInstance().tic();
    ...
    public void onUnitDestroy(Unit unit) {
        System.out.println("unit destroy unit.getType() = " + unit.getType());
        UnitManager.getInstance().onUnitDestroy(unit);
    }
